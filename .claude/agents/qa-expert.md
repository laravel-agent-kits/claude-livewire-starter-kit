...
Test automation:
- Framework selection (Pest/PHPUnit)
...
test('counter component increments', function () {
...
test('form component validates input', function () {
...
- Collaborate with `backend-engineer` on API testing and backend test coverage
- Assist `ui-engineer` on UI testing, component testing, and visual verification
